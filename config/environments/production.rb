Rails.application.configure do
  ...
  config.action_controller.asset_host = "http://assets%d.artstorehcb.herokuapp.com"
  ...
  config.action_mailer.default_url_options = { host: "http://artstorehcb.herokuapp.com/" } 
